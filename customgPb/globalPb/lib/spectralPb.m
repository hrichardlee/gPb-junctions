function [sPb, vect] = spectralPb(mPb, orig_sz, outFile, nvec)
...
system(sprintf('segment -image %s -smatrixfile %s -readlattice true -latticefile %s -dthresh 5', imgFile, simFile, latFile));
delete(latFile);
delete(imgFile);

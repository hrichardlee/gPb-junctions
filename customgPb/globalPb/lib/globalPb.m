function [gPb_thin, gPb, mPb, sPb, vect, origmaxo, maxo] = globalPb(imgFile, outFile, rsz)
% syntax:
...
[sPb, vect] = spectralPb(mPb_rsz, orig_sz, outFile2);
delete(outFile2);
t = toc;
